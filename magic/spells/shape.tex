...
\difficulty\difficulty              & \textbf{Burn:}  All creatures in the area suffer \iqtyref{burn} damage equal to the character's ranks in the Knowledge(Nature) skill.\\
...
effects from ~\tableref{magic-shape}.
