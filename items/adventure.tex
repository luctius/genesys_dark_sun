...
\nameref{advitm:backpack}         & 0     &       & 2      \\
Bedroll                           & 2     &       & 1      \\
Bottle, glass                     & 1     &       & 1      \\
\nameref{advitm:caltrops}         & 1     &       & 3      \\
Candle                            & 0     &       & 0      \\
Canvas (sq. yd.)                  & 1     &       & 1      \\
Chain (10 ft.)                    & 2     &       & 8      \\
Chalk, 1 piece                    & 0     &       & 1      \\
\nameref{advitm:crowbar}          & 1     &       & 8      \\
Firewood (per day)                & 1     &       & 2      \\
Flask (empty)                     & 1     &       & 1      \\
\nameref{advitm:grapplinghook}    & 1     &       & 2      \\
Hammer                            & 1     &       & 0      \\
Hourglass                         & 1     &       & 4      \\
\nameref{advitm:ink}              & 0     &       & 1      \\
Inkpen                            & 0     &       & 1      \\
Jug, clay                         & 1     &       & 0      \\
Ladder, 10-foot                   & 5     &       & 1      \\
\nameref{advitm:lamp_common}      & 1     &       & 1      \\
\nameref{advitm:lantern_bullseye} & 1     &       & 2      \\
\nameref{advitm:lantern_hooded}   & 1     &       & 3      \\
\nameref{advitm:lock}             & 0     &       & 8      \\
\nameref{advitm:manacles}         & 1     &       & 8      \\
Mirror                            & 0     &       & 3      \\
Mug/Tankard, clay                 & 1     &       & 0      \\
\nameref{advitm:oil}              & 1     &       & 1      \\
Parchment (sheet)                 & 0     &       & 3      \\
Pick, miner's                     & 2     &       & 1      \\
Pitcher, clay                     & 1     &       & 0      \\
Pouch, belt (empty)               & 0     &       & 0      \\
Rations, trail (per day)          & 0     &       & 0      \\
\nameref{advitm:ram}              & 4     &       & 6      \\
\nameref{advitm:rope_hemp}        & 1     &       & 1      \\
\nameref{advitm:rope_silk}        & 1     &       & 3      \\
Sealing wax                       & 0     &       & 0      \\
Sewing needle                     & 0     &       & 1      \\
Shovel or spade                   & 2     &       & 0      \\
Signal whistle                    & 0     &       & 1      \\
...
Soap (per lb.)                    & 0     &       & 1      \\
Tent                              & 2     &       & 2      \\
\nameref{advitm:torch}            & 1     &       & 0      \\
\nameref{advitm:vial}             & 1     &       & 0      \\
Waterskin                         & 1     &       & 0      \\
Whetstone                         & 0     &       & 1      \\
\end{GenesysTable}
\end{table*}
