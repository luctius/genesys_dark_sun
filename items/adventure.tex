...
\subsubsection{Poisons}\label{chap:poisons}
...
Name                        & Price & Rarity \\
\nameref{poison:anesthetic} &  375  & 5      \\
\nameref{poison:befuddle}   &  230  & 6      \\
\nameref{poison:blinding}   &  400  & 8      \\
\nameref{poison:weakness}   &  450  & 8      \\
\nameref{poison:suggestion} & 1000  & 9      \\
\nameref{poison:paralysis}  &  260  & 6      \\
\nameref{poison:dendriton}  &  150  & 4      \\
\nameref{poison:raquor}     &  150  & 4      \\
\end{GenesysTable}
\end{table}
...
See \chapterref{rules:equipment} for information regarding Survival Ratings.
