...
\nameref{itmamr:hardenedleather}  & 0       & +1   & 2     & 10cp   & 1      & \nameref{iqty:flimsy} \\
\nameref{itmamr:scalemail}        & 1       & +1   & 2     & 25cp   & 3      & \nameref{iqty:fragile} \\
\nameref{itmamr:chitinarmor}      & 0       & +2   & 3     & 50cp   & 4      & \nameref{iqty:fragile}, \nameref{iqty:solid} 1 \\
\nameref{itmamr:shellarmor}       & 1       & +2   & 3     & 100cp  & 5      & \nameref{iqty:fragile}, \nameref{iqty:noisy}, \nameref{iqty:solid} 2 \\
\nameref{itmamr:breastplate}      & 1       & +2   & 3     & 200    & 6      & \nameref{iqty:fragile}, \nameref{iqty:noisy} \\
\nameref{itmamr:halfplate}        & 1       & +3   & 4     & 600    & 7      & \nameref{iqty:fragile}, \nameref{iqty:noisy}, \nameref{iqty:restrictive}, \nameref{iqty:solid} 2 \\
\nameref{itmamr:fullplate}        & 2       & +3   & 5     & 1250cp & 8      & \nameref{iqty:fragile}, \nameref{iqty:noisy}, \nameref{iqty:restrictive}, \nameref{iqty:solid} 3 \\
\end{GenesysTable}
\end{table*}
\begin{multicols}{2}
