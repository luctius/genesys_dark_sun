...
\nameref{itmmlee:talid}         & +0  & 4    & 1     & 60 cp   & 1      & \iqtyref{backup}, \iqtyref{strapped}, \iqtyref{disorient} 3 \\
\nameref{itmmlee:wristrazors}   & +1  & 3    & 0     & 100 cp  & 2      & \iqtyref{backup}, \iqtyref{strapped}, \iqtyref{pierce} 2 \\
...
\nameref{itmmlee:buckler}    & +0  & 6    & 1     & 40 cp    & 0      & \iqtyref{defensive} 1, \iqtyref{strapped}, \iqtyref{inaccurate} 1 \\
...
\nameref{itmmlee:carrikal}   & +3  & 3    & 2     & 250 cp   & 3      & \iqtyref{vicious} 1 \\
\nameref{itmmlee:alhulak}    & +2  & 4    & 2     & 90 cp    & 2      & \iqtyref{disarm} \\
\nameref{itmmlee:macuahuitl} & +1  & 2    & 2     & 300 cp   & 5      & \iqtyref{vicious} 1, \iqtyref{pierce} 1 \\
\end{GenesysTable}
\end{table*}
...
\nameref{itmmlee:gouge}       & +4  & 2     & 3     & 300 cp    & 4      & \iqtyref{disorient} 2, \iqtyref{strapped}, \iqtyref{unwieldy} 3 \\
\nameref{itmmlee:longspear}   & +3  & 4     & 3     & 250 cp    & 2      & \iqtyref{reach}, \iqtyref{defensive} 1, \iqtyref{pierce} 1 \\
\nameref{itmmlee:lotulis}     & +4  & 3     & 4     & 350 cp    & 4      & \iqtyref{cumbersome} 3, \iqtyref{pierce} 2, \iqtyref{linked} 1\\
\nameref{itmmlee:trikal}      & +3  & 3     & 5     & 250 cp    & 2      & \iqtyref{defensive} 1, \iqtyref{pierce} 1, \iqtyref{vicious} 1\\
\nameref{itmmlee:cahulaks}    & +2  & 3     & 2     & 270 cp    & 3      & \iqtyref{sunder}, \iqtyref{reach}, \iqtyref{unwieldy} 3 \\
\nameref{itmmlee:dragonpaw}   & +2  & 4     & 2     & 315 cp    & 1      & \iqtyref{defensive} 1, \iqtyref{accurate} 1, \iqtyref{disarm} \\
\nameref{itmmlee:gythka}      & +2  & 4     & 2     & 250 cp    & 4      & \iqtyref{thrown}, \iqtyref{linked} 1\\
\end{GenesysTable}
\end{table*}
\begin{multicols}{2}
...
Hence, spears don’t have very high damage, but the \iqtyref{accurate} 1
quality represents their ease of use. In addition, the \iqtyref{defensive} 1
...
the \iqtyref{accurate} 1 quality represents their ease of use.
In addition, the \iqtyref{defensive} 1 quality represents
