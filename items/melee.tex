...
\nameref{itmmlee:talid}         & +0  & 4    & 1     & 60 cp   & 1      & \iqtyref{fragile}, \iqtyref{backup}, \iqtyref{disorient} 3 \\
...
\nameref{itmmlee:cahulaks}    & +2  & 3     & 2     & 240 cp    & 3     & \iqtyref{fragile}, \iqtyref{thrown}, \iqtyref{reach}, \iqtyref{unwieldy} 3 \\
\nameref{itmmlee:dragonpaw}   & +2  & 4     & 2     & 315 cp    & 1     & \iqtyref{fragile}, \iqtyref{defensive} 1, \iqtyref{accurate} 1, \iqtyref{disarm} \\
\nameref{itmmlee:gythka}      & +2  & 4     & 2     & 250 cp    & 4     & \iqtyref{fragile}, \iqtyref{thrown}, \iqtyref{vicious} 1 \\
\end{GenesysTable}
\end{table*}
\begin{multicols}{2}
