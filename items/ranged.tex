...
\nameref{itmrng:dejada}        & 5   & 3    & Medium & 2     & 260 cp   & 2      & \iqtyref{unwieldy} 2, \iqtyref{concussive} \\
\nameref{itmrng:shortbow}      & 7   & 3    & Medium & 2     & 275 cp   & 3      & \iqtyref{unwieldy} 2 \\
\nameref{itmrng:longbow}       & 8   & 3    & Long   & 2     & 450 cp   & 5      & \iqtyref{unwieldy} 3 \\
\nameref{itmrng:weighted_net}  & +0  & 6    & Short  & 3     & 80 cp    & 4      & \iqtyref{ensnare} 4, \iqtyref{disorient} 2, \iqtyref{limitedammo} 1\\
\end{GenesysTable}
\end{table*}
\begin{multicols}{2}
...
blowgun can be poisoned using the poisons described in \chapterref{poisons} with an Easy (\difficulty) Medicine check. While intended for a full
