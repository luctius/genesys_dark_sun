...
\nameref{itmrng:blowgun}  & 6   & 3    & Short  & 2     & 275 cp   & 2      & \iqtyref{limitedammo} 1\\
\nameref{itmrng:bolas}    & +0  & -    & Short  & 1/3   & 20 cp    & 2      & \iqtyref{ensnare} 3, \iqtyref{knockdown}, \iqtyref{limitedammo} 1 \\
\nameref{itmrng:catkcha}  & +2  & 4    & Short  & 1     & 275 cp   & 2      & \iqtyref{fragile}, \iqtyref{unwieldy} 3, \iqtyref{returning}, \iqtyref{limitedammo} 1 \\
\nameref{itmrng:javelin}  & +2  & 3    & Short  & 1/3   & 40 cp    & 2      & \iqtyref{fragile}, \iqtyref{accurate} 1, \iqtyref{pierce} 1, \iqtyref{limitedammo} 1 \\
\nameref{itmrng:dejada}   & 5   & 3    & Medium & 2     & 275 cp   & 2      & \iqtyref{unwieldy} 2, \iqtyref{concussive} \\
\nameref{itmrng:shortbow} & 7   & 3    & Medium & 2     & 275 cp   & 2      & \iqtyref{unwieldy} 2 \\
\nameref{itmrng:longbow}  & 8   & 3    & Long   & 2     & 275 cp   & 2      & \iqtyref{unwieldy} 3 \\
\end{GenesysTable}
\end{table*}
\begin{multicols}{2}
