...
\nameref{itmrng:blowgun}  & 6   & 3    & Short  & 2     & 275 cp   & 2      & \nameref{iqty:limitedammo} 1\\
\nameref{itmrng:bolas}    & +0  & -    & Short  & 1/3   & 20 cp    & 2      & \nameref{iqty:ensnare} 3, \nameref{iqty:knockdown}, \nameref{iqty:limitedammo} 1 \\
\nameref{itmrng:catkcha}  & +2  & 4    & Short  & 1     & 275 cp   & 2      & \nameref{iqty:fragile}, \nameref{iqty:unwieldy} 3, \nameref{iqty:returning}, \nameref{iqty:limitedammo} 1 \\
\nameref{itmrng:javelin}  & +2  & 3    & Short  & 1/3   & 40 cp    & 2      & \nameref{iqty:fragile}, \nameref{iqty:accurate} 1, \nameref{iqty:pierce} 1, \nameref{iqty:limitedammo} 1 \\
\nameref{itmrng:dejada}   & 5   & 3    & Medium & 2     & 275 cp   & 2      & \nameref{iqty:unwieldy} 2, \nameref{iqty:concussive} \\
\nameref{itmrng:shortbow} & 7   & 3    & Medium & 2     & 275 cp   & 2      & \nameref{iqty:unwieldy} 2 \\
\nameref{itmrng:longbow}  & 8   & 3    & Long   & 2     & 275 cp   & 2      & \nameref{iqty:unwieldy} 3 \\
\end{GenesysTable}
\end{table*}
\begin{multicols}{2}
