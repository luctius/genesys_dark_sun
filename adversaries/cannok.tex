...
\Creature[name=Cannok, type=Minion, image=images/cannok.png, brawn=2, agility=2, intellect=1, cunning=3, willpower=1, presence=1, soak=2, wounds=8, meleedef=0, rangeddef=0, magicdef=0, psionicdef=0]
{
    % description
    ...
    Brawl, Coordination, Survival, Resilience
}{
    % talents
    None\\
}{
