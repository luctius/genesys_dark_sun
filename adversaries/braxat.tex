...
\Creature[name=Braxat Lord, type=Nemesis, brawn=5, presence=1, soak=7, wounds=20, strain=15, meleedef=1, rangeddef=1, magicdef=0, psionicdef=2]
{
    % description
}{
    % skill
    ...
    % talents
    Durable 2
    Adversary 2: Upgrade the difficulty of any combat check targeting this character twice.
}{
    \\ % ability
    \textbf{- Huge:} Silhouette 3\\
    \textbf{- Acid Breath: } Once per Encounter, the Braxat can activate
