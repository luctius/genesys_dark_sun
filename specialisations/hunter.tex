%Big Game Hunter
\newcommand{\hunterDescription}{
\section{Hunter}
    Hunter Text\\
    See \nref{tlttree:hunter} for more information.
}

\newcommand{\hunterTree}{
    \newpage
    \subsection{Hunter Talent Tree}
    \label{tlttree:hunter}

    \textbf{Class Skills:} Athletics, Perception, Survival, Knowledge (Nature)
    \newline
