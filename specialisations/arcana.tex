...
\newcommand{\arcanaTree}{
    ...
    \textbf{Class Skills:} Alchemy, Arcana (Attack), Arcana (Barrier), Arcana (Dispel), Arcana (Enchantment), Arcana (Illusion)
    \newline
    ...
    \begin{tikzpicture}
        \draw ( 0,  0) node(aa)[inner sep=0]{\TalentBox[tier=5] {grit}}
              ...
              (12,-10) node(cc)[inner sep=0]{\TalentBox[tier=15]{improvedPotentDefiler}}
