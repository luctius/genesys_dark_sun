...
% 9 & \textbf{Capitalism:} The character is an unabashed capitalist and fights for the rights of the dune traders and the merchant guilds, sometimes running counter to the wishes of either a Sorcerer-king or criminals\\
%10 & \textbf{Support the Tirant:} The character actually supports the goals and methods of an important tirant and does her best to advance its cause. This could be a Sorcerer-king, or an other important tyranical figure.\\
%\end{GenesysTable}
%\end{table*}
%
%\begin{table*}[!htb]
