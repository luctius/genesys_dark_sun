...
As a general rule, items in Dark Sun break with can break with spending either
\threat\threat\threat or \despair, instead of only on a \despair. Items with the
\iqtyref{superior} quality or made from metal are exempt from this rule.
...
\input{items/attachments/superior_weapon_customization}
