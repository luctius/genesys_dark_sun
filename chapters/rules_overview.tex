...
See \chapterref{equipment:survival} for the prices.
...
can be seen in \tableref{skill-challenge-example}. If the skill check succeeds, add the \success
generated to the PCs score. Any \advantage \triumph \threat and \despair generated during skill challenge
checks can be spent on effects from \tableref{skill-challenges-advantage} and \tableref{skill-challenges-threat},
