...
\newcommand\psionicBindTalent{ \Talent[name=\psionicBindTitle, label=psionicbind, active=false, ranked=true]{\psionicBindDescription} }
...
\newcommand\bindDurationTalent{ \Talent[name=\bindDurationTitle, label=psionicbindduration, active=false, ranked=true]{\bindDurationDescription} }
...
\newcommand\bindControlTalent{ \Talent[name=\bindControlTitle, label=psionicbindcontrol, active=false, ranked=true]{\bindControlDescription} }
...
\newcommand\bindMagnitudeTalent{ \Talent[name=\bindMagnitudeTitle, label=psionicbindmagnitude, active=false, ranked=true]{\bindMagnitudeDescription} }
...
\newcommand\bindRangeTalent{ \Talent[name=\bindRangeTitle, label=psionicbindrange, active=false, ranked=true]{\bindRangeDescription} }
...
\newcommand\bindStrengthTalent{ \Talent[name=\bindStrengthTitle, label=psionicbindstrength, active=false, ranked=true]{\bindStrengthDescription} }
...
\newcommand\bindMasteryTalent{ \Talent[name=\bindMasteryTitle, label=psionicbindmastery, active=false, ranked=true]{\bindMasteryDescription} }
